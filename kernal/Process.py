...
from kernal.FileSystem import UserFile, FileOperation
from kernal.IOSystem import Device, DeviceRequest
from kernal.PageAndFrame import Page
...
def setAlgorithm(alg):
    global scheduling_algorithm
    if alg == 0:
        scheduling_algorithm = ProcessAlgorithm.PrioritySync
    elif alg == 1:
        scheduling_algorithm = ProcessAlgorithm.PriorityAsync
    elif alg == 2:
        scheduling_algorithm = ProcessAlgorithm.FCFS
    else:
        scheduling_algorithm = ProcessAlgorithm.RR
